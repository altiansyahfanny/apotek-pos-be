...
const create = [
  ...
  check("price").trim().notEmpty().withMessage("Harga Jual tidak boleh kosong").isInt({ min: 1 }).withMessage("Harga Jual tidak boleh kosong, minimal 1"),
